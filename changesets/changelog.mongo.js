...
// changeset jlewis:1 labels:release-1.0.0 runWith:mongosh
...
// changeset jlewis:2 labels:release-1.0.0 runWith:mongosh
...
// changeset jlewis:3 labels:release-1.1.0 runWith:mongosh
db.createCollection('Addresses');
// rollback db.Addresses.drop()

// changeset jlewis:4 labels:release-1.1.0 runWith:mongosh
